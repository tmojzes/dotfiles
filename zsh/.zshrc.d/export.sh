...
export PATH=$PATH:$GOBIN:$HOME/.local/bin:$CARGO_BIN:$FLYCTL_INSTALL/bin:$ODIN_BIN:$BUN_BIN:${RANCHER_BIN:+$RANCHER_BIN:}$GO_INSTALL_PATH:$OPENCODE_BIN":$NODE_USER_BIN
