...
export PATH=$PATH:$HOME/go/bin:$HOME/.cargo/bin:"${KREW_ROOT:-$HOME/.krew}/bin":$ZIG_PATH:$DOOM_EMACS_PATH
...
set -o vi
export EDITOR="lvim"
export BWS_ACCESS_TOKEN=0.f9f4c0c1-b115-4526-b483-b06800a2d826.4uehrQzietFbk9Ip2qZ9Eule2xAm1V:EGwrnVC7Ajbfj7mFnSYXtA==
